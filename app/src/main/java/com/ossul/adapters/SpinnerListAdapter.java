...
public class SpinnerListAdapter extends BaseAdapter {
    ...
    public SpinnerListAdapter(BaseActivity context, ArrayList<? extends BaseResponse> list, ArrayList<String> nameList) {
    ...
    public SpinnerListAdapter(BaseActivity context, ArrayList<String> nameList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.adapter_spinner_item,
                    parent, false);
        }
