...
import com.ossul.activities.SubmitRealEstateNewsActivity;
...
public class RealEstateNewsAdapter extends RecyclerView.Adapter<RealEstateNewsAdapter.ViewHolder> {
    private static JSONObject jsonObject;
    private ArrayList<RealEstateNewsList> mRealEstateNewsList;
    private BaseActivity mActivity;

    public RealEstateNewsAdapter(BaseActivity activity, ArrayList<RealEstateNewsList> realEstateNewsList, JSONObject jsonObject) {
        this.mActivity = activity;
        this.jsonObject = jsonObject;
        this.mRealEstateNewsList = realEstateNewsList;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (mRealEstateNewsList == null)
            return;
        holder.setData(mRealEstateNewsList.get(position), mActivity);
    }

    @Override
    public int getItemCount() {
        return mRealEstateNewsList != null ? mRealEstateNewsList.size() : 0;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(final RealEstateNewsList realEstateNewsList, final BaseActivity activity) {
            if (images != null)
                images.clear();
                ...
                mShareTV.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            String shareText = "";
                            String link = "http://www.ossul.com/real-estate-news/";
                            if (!Validator.isEmptyString(realEstateNewsList.title)) {
                               /* if (Validator.isProbablyArabic(realEstateNewsList.title)) {
                                ...
                                } else*/
                                {
                                    ...
                                    link = link + strTitle + "/" + realEstateNewsList.realEstateNewsId;
