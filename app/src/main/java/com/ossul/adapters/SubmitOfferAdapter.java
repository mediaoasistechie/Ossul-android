...
public class SubmitOfferAdapter extends RecyclerView.Adapter<SubmitOfferAdapter.ViewHolder> implements Filterable {
    ...
    public SubmitOfferAdapter(BaseActivity activity, ArrayList<SubmitOfferResponse> lists, JSONObject jsonObject) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(final SubmitOfferResponse response, final int position) {
            ...
            mByTV.setText(AppUtilsMethod.getValueFromKey(jsonObject, "By") + " " + response.requestedBy);

            if (!Validator.isEmptyString(AppPreferences.get().getUserId()) && !AppPreferences.get().getUserId().equalsIgnoreCase(response.ownerId)) {
            ...
            mEditTV.setText(AppUtilsMethod.getValueFromKey(jsonObject, "Make Offer"));
